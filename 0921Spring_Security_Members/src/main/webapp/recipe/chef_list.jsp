	...
	<div class="container">
					...
					<td>
						...
						<table class="table">
							<tr>
								...
								<td width=70% colspan="4"><a href="../recipe/chef_detail.do?no=${vo.no }"><h3>${vo.chef }</h3></a></td>
							</tr>
							<tr>
		...
		<div class="row">
			<div class="text-center">
				...
				<a href="../recipe/chef_list.do?page=${curpage<totalpage?curpage+1:curpage }" class="btn btn-sm btn-warning">다음</a>
			</div>
		</div>
	</div>
</body>
