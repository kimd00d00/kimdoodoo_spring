...
$(function(){
	...
	$('#addBtn').click(function(){
		...
		fileIndex=fileIndex+1; //파일이 추가될 때마다 Index에 1 추가
	})
	//파일 추가 취소
...
<body>
	<div class="container">
		<h1>글쓰기</h1>
		<div class="row">
		<form method=post action="insert_ok.do" id="frm" enctype="multipart/form-data"> <!-- 파일첨부할때 꼭!! enctype 지정! -->
			<table class="table"> 
				<tr>
